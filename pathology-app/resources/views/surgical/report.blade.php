    ...
    <div class="layout">
        ...
        <div class="menu-left" data-html2canvas-ignore> 
            ...
            <div>
                ...
                <i id="dow-image1" class="fa fa-download" onclick="PageControl.SaveTolocal('image1')"></i>  
            </div>     
            <div>
                <label for="cpage2">
                    <input type="checkbox" name="cpage2" id="cpage2" onclick="CKE.Choose(this, 'image2')" checked>2
                </label>
                <i id="dow-image2" class="fa fa-download" onclick="PageControl.SaveTolocal('image2')"></i>
            </div>
            <div>
                <label for="cpage3">
                    <input type="checkbox" name="cpage3" id="cpage3" onclick="CKE.Choose(this, 'image3')" checked>3                 
                </label>
                <i id="dow-image3" class="fa fa-download" onclick="PageControl.SaveTolocal('image3')"></i>
            </div>
            <div>
                <label for="cpage4">
                    <input type="checkbox" name="cpage4" id="cpage4" onclick="CKE.Choose(this, 'image4')" checked>4                 
                </label>
                <i id="dow-image4" class="fa fa-download" onclick="PageControl.SaveTolocal('image4')"></i>
            </div>
            <div>
                <label for="cpage5">
                    <input type="checkbox" name="cpage5" id="cpage5" onclick="CKE.Choose(this, 'image5')" checked>5                 
                </label> 
                <i id="dow-image5" class="fa fa-download" onclick="PageControl.SaveTolocal('image5')"></i>
            </div>
